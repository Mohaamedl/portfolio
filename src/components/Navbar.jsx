        ...
        <nav className = {`${styles.paddingX} w-full items-center py-5 fixed top-0 z-20 bg-primary`}>
            <div className = "w-full flex justify-between items-center max-w-7xl mx-auto">
                ...
                onClick={() => {
                    ...
                    <img src={logo} alt="logo" className="w-12 h-12 object-contain rounded-md" />
                    <p className = "text-white text-[18px] font-bold cursor-pointer flex" >Mohamed Haddadi &nbsp;
                ...
                <div className = "sm:hidden flex flex-1 justify-end items-center" >
                    ...
                    {navLinks.map((link) => (
                        ...
                        className={`${
                            active===link.title? "text-white": "text-secondary"
                        } cont-poppins font-medium cursor-pointer text-[16px]`}
                        onClick={() => {
                            setToggle(!toggle)
